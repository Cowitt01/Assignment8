...
class SuperDate extends Date {  
    ...
    getShortDayName() {            // Returns the first three letters of the day name (substring 0 to 3) - calls getFullDayName method to get Day Name
    ...
    getShortMonthName() {          // Returns the first three letters of the month name (substring 0 to 3) - calls getFullMonthName method to get Month Name
